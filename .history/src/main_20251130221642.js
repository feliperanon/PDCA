...
const docData = {
  ...
  plan: {
    ...
    responsavel: planResponsavel.value,
    timeOuTurno: planTimeTurno.value || "",
    dataAlvo: planDataAlvo.value || "", // formato "YYYY-MM-DD" vindo do input date
    tipoObjeto: planTipoObjeto.value || "",
    descricaoObjeto: planDescricaoObjeto.value || "",
  ...
  async function carregarDados(uid) {
    ...
    atualizarTabelaPrioridades(tabelaPrioridades, mapaArea);
  }
  ...
  function atualizarTabelaPrioridades(tabela, mapaArea) {
    if (!tabela) return;
