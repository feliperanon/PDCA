...
export function PdcaDetailPage() {
  ...
  // --------- SALVAR POR CARD (CONTROLAM O PRÓPRIO LOADING) ---------
      ...
      <div className="detail-header">
        ...
        <div className="detail-actions">
          ...
          <button
            ...
            disabled={savingProject || !canConcluir || situacao !== "ativo"}
          ...
          <button
            ...
            disabled={savingProject || situacao !== "ativo"}
        ...
        <section className="form-section detail-card">
          ...
          <fieldset disabled={!checkOK}>
            ...
            <label>
              ...
              <textarea
                value={actLicoes}
                onChange={(e) => setActLicoes(e.target.value)}
                rows={3}
                placeholder="O que você aprendeu, mesmo se não funcionou?"
              />
            </label>
          </fieldset>

          {checkOK && actFuncionou === "nao" && (
            <div style={{ marginTop: "12px" }}>
              <button
                type="button"
                className="btn-secondary"
                onClick={handleReabrirCiclo}
                disabled={savingProject}
              >
                {savingProject
                  ? "Processando..."
                  : "Abrir novo ciclo de PDCA a partir deste (não funcionou)"}
              </button>
            </div>
          )}
