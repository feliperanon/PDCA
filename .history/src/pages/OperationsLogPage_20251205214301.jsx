            ...
            <div className="card" style={{marginTop: '20px', overflowX: 'auto'}}>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        {registros.length === 0 && (
                            <tr><td colSpan="4" style={{textAlign:'center', color:'#999'}}>Nenhum registro ainda.</td></tr>
                        )}
                    </tbody>
                </table>
            </div>
            ...
            {modalAberto && (
                <div className="modal-overlay">
                    <div className="modal-content">
                        ...
                        <label style={{fontWeight:'bold', display:'block', marginBottom:'5px'}}>P (Problema - Automático)</label>
                        <input value={pdca.problema} readOnly style={{background:'#f3f4f6'}} />
                        
                        <label style={{fontWeight:'bold', display:'block', marginBottom:'5px'}}>D (Causa Raiz)</label>
                        <textarea placeholder="Por que aconteceu?" value={pdca.causa} onChange={e => setPdca({...pdca, causa: e.target.value})} />
                        
                        <label style={{fontWeight:'bold', display:'block', marginBottom:'5px'}}>A (Ação Imediata)</label>
