...
export function AnalyticsDashboard() {
    ...
    // 1. Dados para Pareto (Erros por Categoria)
    ...
    // 2. Dados para Tendência (Últimos 7 dias)
    ...
    const categoriaProblematica = dadosPareto.length > 0 ? dadosPareto[0].name : "Nenhuma";
        ...
        <div className="dash-container">
            ...
            <div className="gamification-grid">
                ...
                <div className="medal-card" style={{borderColor:'#e5e7eb'}}>
                    ...
                    <span className="medal-label">Registos Totais</span>
                </div>
            </div>
            ...
            <div className="charts-grid">
                <div className="chart-card">
                    <div className="chart-header">
                        ...
                        <small style={{color:'#dc2626'}}>Onde estamos a falhar?</small>
                    </div>
            ...
            <div className="search-section">
                ...
                {searchTerm && (
                    <div className="results-list">
                        {resultados.length === 0 ? (
                            <div style={{textAlign:'center', color:'#999', padding:20}}>Nenhum registo encontrado.</div>
                        ) : (
                            resultados.map(log => (
                                <div key={log.id} className="result-item" style={{borderLeftColor: log.tipo.includes('Erro') ? '#dc2626' : '#16a34a'}}>
                                    ...
                                    <div className="result-suggestion">
                                        💡 Dica: Verificar se foi criado PDCA nesta data.
                                    </div>
                                </div>
                            ))
                        )}
