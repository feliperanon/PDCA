...
function PdcaCard({ pdca }) {
  ...
  const dataAlvoDate = pdca.dataAlvo ? new Date(pdca.dataAlvo + "T00:00:00") : null;
  ...
  let atrasoLabel = "-";
  let atrasoDias = null;
  if (dataAlvoDate && pdca.status !== "Padronizado") {
    const hoje = new Date();
    const diffMs = hoje.getTime() - dataAlvoDate.getTime();
    atrasoDias = Math.floor(diffMs / (1000 * 60 * 60 * 24));
    if (atrasoDias > 0) {
      ...
      try {
        ...
        snap.forEach((docSnap) => {
          ...
          docs.push({
            ...
            // carimbos de tempo entre fases (preparados na página de detalhe)
  ...
  return (
    <div className="page">
      ...
      <p className="page-subtitle">
        Quadro em quatro colunas: Plan, Do, Check e Act. De um olhar só, você
        enxerga onde está travando e quanto tempo está levando para andar.
      </p>
