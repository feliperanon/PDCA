    ...
    () => [
      ...
      },
      {
        ...
        predicate: (p) => {
          ...
          // "prazo vencendo ou vencido" → data alvo <= hoje
      ...
      },
      {
        ...
        descricao:
          "PDCAs ligados a clientes Premium (campo de cliente ou tipo marcando Premium).",
        predicate: (p) => {
          const cliente = (p.cliente || "").toLowerCase();
          const tipo = (p.clienteTipo || "").toLowerCase();
          return (
            tipo === "premium" || cliente.includes("premium")
          );
        },
      },
    ],
  ...
  return (
    <div className="page">
      ...
      <p className="page-subtitle">
        Quadro em quatro colunas: Plan, Do, Check e Act. Visões rápidas para
        o gestor enxergar só o que interessa na reunião.
      </p>

      <section className="dashboard-filters">
        <header className="dashboard-filters-header">
          <h2>Visões rápidas</h2>
