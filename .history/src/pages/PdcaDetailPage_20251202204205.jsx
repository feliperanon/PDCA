...
export function PdcaDetailPage() {
  ...
  async function savePdcaCore() {
    ...
    setError("");
    // não mexe no globalMessage aqui (mensagens locais por card)
    ...
    <div className="page">
      ...
      {!isAtivo && (
        <div className="alert">
          ...
          campos estão apenas para consulta, sem edição.
        </div>
      )}
      ...
      <div className="detail-grid">
        ...
        <section className="form-section detail-card">
          ...
          {isAtivo ? (
            ...
            <p className="section-readonly-hint">
              Projeto {situacaoLabel.toLowerCase()}: Act apenas para consulta.
            </p>
          )}
        </section>
      </div>
