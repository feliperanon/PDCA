// src/pages/OperationsLogPage.jsx
import React, { useState } from 'react';
import '../style.css'; // Garante que carrega os estilos

export function OperationsLogPage() {
    // Estado para guardar a lista de registros
    ...
    return (
        <div className="container-page">
            <h1 style={{ marginBottom: '20px', color: '#333' }}>Diário de Operações Logísticas</h1>

            {/* Formulário */}
            <div className="form-box">
                <h3 style={{ marginTop: 0 }}>Registrar Nova Informação</h3>
                ...
                <div className="form-group">
                    ...
                    <textarea 
                        rows="3" 
                        placeholder="Escreva aqui o detalhe..."
