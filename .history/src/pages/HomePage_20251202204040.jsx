...
export function HomePage() {
  ...
  // Quebra a lista por etapa (somente ativos)
  ...
  // Contadores pro card de Dashboard
          ...
          <div className="home-card home-card-dashboard">
            <header>
              ...
              <p>
                ...
                etapa do ciclo e quantos já foram encerrados.
              </p>
            </header>
            ...
            <div className="home-dashboard-metrics">
              ...
              <div>
                <span className="metric-label">Plan (ativos)</span>
                <span className="metric-value">{totalPlan}</span>
              </div>
              <div>
                <span className="metric-label">Do (ativos)</span>
                <span className="metric-value">{totalDo}</span>
              </div>
              <div>
                <span className="metric-label">Check (ativos)</span>
                <span className="metric-value">{totalCheck}</span>
              </div>
              <div>
                <span className="metric-label">Act (ativos)</span>
                <span className="metric-value">{totalAct}</span>
              </div>
            </div>

            <footer className="home-dashboard-actions">
              <Link to="/dashboard" className="btn-primary">
                Abrir dashboard detalhado (quadro Plan / Do / Check / Act)
              </Link>
              <Link to="/historico" className="btn-secondary">
                Ver histórico (concluídos e cancelados)
              </Link>
            </footer>
          </div>
        </div>
