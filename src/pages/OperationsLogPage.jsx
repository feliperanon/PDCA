                    ...
                    <section className="modal-card plan-card">
                        ...
                        <div className="card-content">
                            ...
                            <div className="form-grid-2">
                                <div><label>Indicador Antes</label><input placeholder="Ref..." value={pdcaForm.indicadorAntes} onChange={(e) => setPdcaForm({...pdcaForm, indicadorAntes: e.target.value})} /></div>
                                <div><label>Indicador Meta</label><input placeholder="Alvo..." value={pdcaForm.indicadorMeta} onChange={(e) => setPdcaForm({...pdcaForm, indicadorMeta: e.target.value})} /></div>
                            </div>
